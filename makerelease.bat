::--------------------------------------------------------------------
:: create release package for infoDeck extension
::--------------------------------------------------------------------
@echo off
setlocal ENABLEDELAYEDEXPANSION
setlocal 

set PACKAGE_NAME="infoDeck"
set PACKAGE_RELEASEFILE_PREFIX=infodeck_release_
set PACKAGE_VERSION=
...
rem xcopy background.js release_staging  >> makerelease.log 2>&1
